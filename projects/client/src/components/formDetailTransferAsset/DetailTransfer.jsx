...
export default function DetailTransfer({ detailData = [], img = {} }) {
    ...
    <div className="px-4 sm:px-6 lg:px-8">
      ...
      <div className="-mx-4 mt-8 flex flex-col sm:-mx-6 md:mx-0">
        <table className="min-w-full divide-y divide-gray-300">
          ...
          {detailData.m_trans_ds.map((transd, stockIdx) => (
            <tbody>
              <tr
                key={transd.id}
        ...
        <div className="space-y-6 pt-8 sm:space-y-5 sm:pt-10">
          ...
          <div className="space-y-6 sm:space-y-5">
            ...
            <div className="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:border-t sm:border-gray-200 sm:pt-5">
              ...
              <div className="mt-1 sm:col-span-2 sm:mt-0">
                {detailData.CabangIn.cabang_name}
              </div>
            </div>
            ...
            <div className="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:border-t sm:border-gray-200 sm:pt-5">
              ...
              <div className="mt-1 sm:col-span-2 sm:mt-0">
                {detailData.user_transfer.username}
              </div>
            </div>
            <div className="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:border-t sm:border-gray-200 sm:pt-5">
              <label
              ...
              <div className="mt-1 sm:col-span-2 sm:mt-0">
                {detailData.user_penerima.username}
              </div>
            </div>
              ...
              <div className="sm:col-span-6">
                ...
                <div className="mt-1">
                  <textarea
                    ...
                    name="desc"
                    rows={3}
                    defaultValue={detailData.desc_received}
                    className="p-2 block w-full rounded-md border border-gray-400 border-gray-300 shadow-sm focus:border-orange-500 focus:ring-orange-500 sm:text-sm"
                    disabled
                  />
                </div>
