    ...
    <div className="px-4 sm:px-6 lg:px-8">
      ...
      <div className="-mx-4 mt-8 flex flex-col sm:-mx-6 md:mx-0">
        <table className="min-w-full divide-y divide-gray-300">
          ...
          {detailData.map((data) =>
            data.m_trans_ds.map((transd, stockIdx) => (
              <tbody>
                <tr
                  key={transd.id}
          ...
          <div className="space-y-6 sm:space-y-5">
            <div className="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:border-t sm:border-gray-200 sm:pt-5">
              ...
              <div className="mt-1 sm:col-span-2 sm:mt-0">
                {detailData &&
                  detailData[0] &&
                  detailData[0].CabangOut &&
                  detailData[0].CabangOut.cabang_name}
              </div>
            </div>
            ...
            <div className="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:border-t sm:border-gray-200 sm:pt-5">
              ...
              <div className="mt-1 sm:col-span-2 sm:mt-0">
                {detailData &&
                  detailData[0] &&
                  detailData[0].CabangIn &&
                  detailData[0].CabangIn.cabang_name}
              </div>
            </div>
            ...
            <div className="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:border-t sm:border-gray-200 sm:pt-5">
              ...
              <div className="mt-1 sm:col-span-2 sm:mt-0">
                <div className="mt-1 sm:col-span-2 sm:mt-0">
                  {detailData &&
                    detailData[0] &&
                    detailData[0].user_transfer.username}
                </div>{" "}
              </div>
            </div>
            <div className="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:border-t sm:border-gray-200 sm:pt-5">
              ...
              <div className="mt-1 sm:col-span-2 sm:mt-0">
                <div className="mt-1 sm:col-span-2 sm:mt-0">
                  {detailData &&
                    detailData[0] &&
                    detailData[0].user_penerima.username}
                </div>{" "}
              </div>
            </div>
