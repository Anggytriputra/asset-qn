...
export default function DetailReturn({ asset = {}, img = {} }) {
          ...
          <div className="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
            <div className="sm:col-span-2">
              ...
              <input
                ...
                defaultValue={asset.no_return}
                disabled
                // required
              />
            </div>

            {asset.m_trans_d_returns[0].m_category.name === "Kendaraan" && (
              <div className="sm:col-span-2">
                <label
                  htmlFor="noPolisi"
                  className="block text-sm font-medium text-gray-700"
                ...
                <input
                  ...
                  defaultValue={asset.m_trans_d_returns[0].no_polisi}
                  disabled
                />
              </div>
            )}
            ...
            {asset.m_trans_d_returns[0].m_category.name === "Special Tools" && (
              <div className="sm:col-span-2">
                <label
                  htmlFor="seriNumber"
                  className="block text-sm font-medium text-gray-700"
                ...
                <input
                  type="text"
                  className="p-2 border border-gray-400 spin-hidden block w-full min-w-0 flex-1 rounded-md border-gray-300 focus:border-orange-500 focus:ring-orange-500 sm:text-sm"
                  defaultValue={asset.m_trans_d_returns[0].serial_number}
                  disabled
                />
              </div>
            )}
            ...
            <div className="sm:col-span-2 ">
              ...
              <input
                ...
                // id="seriNumber"
                className="p-2 border border-gray-400 spin-hidden block  w-full min-w-0 flex-1 rounded-md border-gray-300 focus:border-orange-500 focus:ring-orange-500 sm:text-sm"
                defaultValue={asset.statusReturn.name}
                disabled
              />
            </div>
            ...
            <div className="sm:col-span-2 ">
              ...
              <input
                ...
                // id="seriNumber"
                className="p-2 border border-gray-400 spin-hidden block  w-full min-w-0 flex-1 rounded-md border-gray-300 focus:border-orange-500 focus:ring-orange-500 sm:text-sm"
                defaultValue={asset.m_trans_d_returns[0].m_category.name}
                disabled
              />
            </div>
            ...
            <div className="sm:col-span-2 ">
              ...
              <input
                ...
                // id="noPolisi"
                className="p-2 border border-gray-400 spin-hidden block  w-full min-w-0 flex-1 rounded-md border-gray-300 focus:border-orange-500 focus:ring-orange-500 sm:text-sm"
                defaultValue={asset.createdAt.split("T")[0]}
                disabled
              />
            </div>
            ...
            <div className="sm:col-span-2">
              ...
              <input
                ...
                id="assetName"
                className="p-2 block w-full min-w-0 flex-1 rounded-md border border-gray-300 focus:ring-orange-500 sm:text-sm"
                defaultValue={asset.m_trans_d_returns[0].m_asset_name}
                disabled
                // required
              />
            </div>
            <div className="sm:col-span-2">
              ...
              <input
                ...
                // id="pic"
                className="p-2 block w-full min-w-0 flex-1 rounded-md border border-gray-300 focus:ring-orange-500 sm:text-sm"
                defaultValue={asset.recipient_name}
                disabled
              />
            </div>
            ...
            <div className="sm:col-span-2 ">
              ...
              <input
                ...
                id="owner"
                className="p-2 block w-full min-w-0 flex-1 rounded-md border border-gray-300 focus:ring-orange-500 sm:text-sm"
                defaultValue={asset.destination}
                disabled
              />
            </div>
            ...
            <div className="sm:col-span-2 ">
              ...
              <input
                ...
                id="user"
                className="p-2 block w-full min-w-0 flex-1 rounded-md border border-gray-300 focus:ring-orange-500 sm:text-sm"
                defaultValue={asset.userReturn.username}
                disabled
              />
            </div>
